 ...
 * @author Shai Almog
 */
public class ProtocolloStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "Protocollo";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new ProtocolloStub());
    }
